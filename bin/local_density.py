...
# Constants
Far_Radius = 10.0   # Far limit to count far local density
Mid_Radius = 5.0    # Mid limit to count mid local density
Near_Radius = 2.5   # Near limit to count near local density
...
class Atom:
    def __init__(self):
        ...
        self.local_density_near = 0   # Local density score, integer, count of atoms within Near_Radius

    def __repr__(self):
        return f"{self.line[:30]}{self.xyz.x:8.3f}{self.xyz.y:8.3f}{self.xyz.z:8.3f}{self.radius:8.3f}{self.local_density_near:8d}{self.local_density_mid:8d}{self.local_density_far:8d}"
...
class Protein:
    ...
    def calculate_local_density(self):
        ...
        for i, atom in enumerate(self.atoms):
            ...
            neighbor_indices_near = indices_near[i]
            ...
            atom.local_density_near = len(neighbor_indices_near) - 1
