...
class Atom:
    ...
    def as_mccepdb_line(self):
        ...
        return "ATOM  %5d %4s %3s %c%04d%c%03d%8.3f%8.3f%8.3f%8.3f%12.3f      %s\n" % (
            serial,
            self.atomname,
            self.parent_conf.parent_residue.resname,
            self.parent_conf.parent_residue.chain,
            self.parent_conf.parent_residue.sequence,
            self.parent_conf.parent_residue.insertion,
